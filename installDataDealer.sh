...
INTELROCCS_CERT=/usr/local/IntelROCCS/certs/usercert.pem
INTELROCCS_KEY=/usr/local/IntelROCCS/certs/userkey.pem
INTELROCCS_SSO_COOKIE=/usr/local/IntelROCCS/certs/ssocookie.txt
...
echo "os.environ['INTELROCCS_CERT']='"${INTELROCCS_CERT}"'" >> $INIT_FILE
echo "os.environ['INTELROCCS_KEY']='"${INTELROCCS_KEY}"'" >> $INIT_FILE
echo "os.environ['INTELROCCS_SSO_COOKIE']='"${INTELROCCS_SSO_COOKIE}"'" >> $INIT_FILE
